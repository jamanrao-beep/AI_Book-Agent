    ...
    <div style={{ minHeight: "100vh", display: "flex", fontFamily: "'DM Sans', sans-serif", background: "#f7f2e4" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse 70% 60% at 20% 70%, rgba(59,111,255,0.1) 0%, transparent 70%), radial-gradient(ellipse 50% 40% at 80% 20%, rgba(155,109,255,0.06) 0%, transparent 60%)",
        }} />
        ...
        <div style={{ position: "relative", zIndex: 3, padding: "36px 44px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div style={{
              ...
              background: "linear-gradient(135deg, #3B6FFF, #6B93FF)",
              borderRadius: "7px",
              display: "flex", alignItems: "center", justifyContent: "center",
              boxShadow: "0 2px 10px rgba(59,111,255,0.4)",
            }}>
            ...
            <>
              ...
              {error && (
                <div style={{
                  ...
                  fontSize: "13px", color: "#FF4D6A", marginBottom: "20px",
                }}>{error}</div>
              )}
                ...
                <div>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "7px" }}>
                    ...
                    <button type="button" style={{
                      ...
                      color: "#6B93FF", cursor: "pointer", fontWeight: "600",
                    }}>Forgot?</button>
                  </div>
                  <div style={{ position: "relative" }}>
                    <input type={showPass ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)}
